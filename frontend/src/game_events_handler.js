class GameEventHandler {
    ...
    cue_collide_no_target_ball_first(e) {
        if (this.tableState.currPlayer.ballGroup === null)
            return false;
        if (e[1] === 'collide') {
    ...
    detectFouls(events, playerGroup) {
        ...
        let rulesToCheck =
            [
                [this.cue_collide_no_ball.bind(this), foulsMeta.CUE_COLLIDE_NO_BALL],
        ...
        let fLen = this.tableState.breakShotDone ? this.foulsMeta.length - 1 : this.foulsMeta.length;
